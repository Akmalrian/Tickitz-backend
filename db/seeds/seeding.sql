...
VALUES (1, 4),
       (1, 7),   -- Monster Pabrik Rambut: Horror, Thriller
       (2, 4),   -- Kucing Hitam: Horror
       (3, 2),
       (3, 4),   -- Warkop DKI: Comedy, Horror
       (4, 4),
       (4, 7),
       (4, 1),   -- Colony: Horror, Thriller, Action
       (5, 1),
       (5, 9),
       (5, 10),  -- Masters of the Universe: Action, Adventure, Fantasy
       (6, 1),
       (6, 3),   -- Nobody Loves Kay: Action, Drama
       (7, 3),
       (7, 5),   -- Jangan Buang Ibu: Drama, Romance
       (8, 3),
       (8, 9),   -- Garuda di Dadaku: Drama, Adventure
       (9, 3),
       (9, 7),   -- Tanah Runtuh: Drama, Thriller
       (10, 1),
       (10, 7),
       (10, 11), -- The Furious: Action, Thriller, Crime
       (11, 8),
       (11, 9),
       (11, 2),  -- Toy Story 5: Animation, Adventure, Comedy
       (12, 1),
       (12, 9),
       (12, 6),  -- Supergirl: Action, Adventure, Sci-Fi
       (13, 6),
       (13, 7),  -- Disclosure Day: Sci-Fi, Thriller
       (14, 4),
       (14, 2),  -- Dukun Magang: Horror, Comedy
       (15, 3),
       (15, 7),  -- Cerita Lila: Drama, Thriller
       (16, 12), -- The Longest Wait: Documentary
       (17, 8),
       (17, 2),
       (17, 9),  -- Minions & Monsters: Animation, Comedy, Adventure
       (18, 4),
       (18, 7),
       (18, 6);
-- Backrooms: Horror, Thriller, Sci-Fi
...
VALUES (1, 1),   -- Monster Pabrik Rambut — Jose Poernomo
...
VALUES (1, 1),
       (1, 2),   -- Monster Pabrik Rambut: Iqbaal, Rachel Amanda
       (2, 3),
       (2, 4),   -- Kucing Hitam: Caroline Zachrie, Keiko Ananta
       (3, 5),
       (3, 6),
       (3, 7),
       (3, 8),
       (3, 9),   -- Warkop DKI
       (4, 25),
       (4, 26),  -- Colony: (karakter Korea, pakai aktor lokal populer utk demo)
       (5, 13),
       (5, 14),
       (5, 15),  -- Masters: Nicholas Galitzine, Camila Mendes, Idris Elba
       (6, 27),
       (6, 28),  -- Nobody Loves Kay: Chelsea Islan, Nicholas Saputra
       (7, 9),
       (7, 29),  -- Jangan Buang Ibu: Marsha Timothy, Adipati Dolken
       (8, 26),
       (8, 30),  -- Garuda: Prilly Latuconsina, Refal Hady
       (9, 5),
       (9, 25),  -- Tanah Runtuh: Vino G. Bastian, Reza Rahadian
       (10, 21),
       (10, 22), -- The Furious: Joe Taslim, Yayan Ruhian
       (11, 18),
       (11, 19), -- Toy Story 5: Tom Hanks (Woody), Tim Allen (Buzz)
       (12, 16),
       (12, 17), -- Supergirl: Milly Alcock, Jason Momoa
       (13, 23),
       (13, 24), -- Disclosure Day: Emily Blunt, Josh O''Connor
       (14, 10),
       (14, 11),
       (14, 12), -- Dukun Magang: Jefan, Hana, Dodit
       (15, 27),
       (15, 29), -- Cerita Lila: Chelsea Islan, Adipati Dolken
       (16, 25), -- The Longest Wait
       (17, 20), -- Minions & Monsters: Steve Carell (Gru)
       (18, 26),
       (18, 28);
-- Backrooms: Prilly, Nicholas Saputra
...
VALUES (6, 3, 40),
       (6, 4, 40);
-- Booking 7 (user 10, showtime 44 = Film 8, cinema 1, qty 2) → F1,F2 (row F - regular)
INSERT INTO booking_seats (booking_id, seat_id, showtime_id)
VALUES (7, 71, 44),
       (7, 72, 44);
...
VALUES (15, 197, 37),
       (15, 198, 37);
-- Booking 16 (user 19, showtime 41 = Film 7 hiflix, cinema 2, qty 2) → F3,F4 (row F - regular)
INSERT INTO booking_seats (booking_id, seat_id, showtime_id)
VALUES (16, 171, 41),
       (16, 172, 41);
...
INSERT INTO booking_seats (booking_id, seat_id, showtime_id)
VALUES (28, 45, 34);
-- Booking 29 (user 12, showtime 39 = Film 7, CURRENT_DATE-1, qty 2) → F5,F6 (row F - regular)
INSERT INTO booking_seats (booking_id, seat_id, showtime_id)
VALUES (29, 75, 39),
       (29, 76, 39);
